...
All adapters inherit the repository contract from `AGENTS.md`. Student-facing
navigation and decision questions use explicit choices, while learning
evidence uses the structured response contract in

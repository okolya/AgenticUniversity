# University Staff Registry

University-wide discovery index. Worker files are the canonical appointment records; this table is an index only. Authority comes from Profession + Worker appointment + Policies.

| Worker | Profession | Appointment | Faculty / scope | Status | Worker file |
|---|---|---|---|---|---|
